<div class="flex justify-center lg:-mx-12 my-12 p-6 md:px-12 bg-grey-lighter border border-grey-light text-sm md:rounded shadow">
    ...
    <div id="mc_embed_signup">
        <form action="https://doingandlearning.us15.list-manage.com/subscribe/post?u=72c68ddfdcc887b8f2f127f3f&amp;id=5aab8a7f77" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
